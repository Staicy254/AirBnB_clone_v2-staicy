...
# Performs Installation, configuration, and starts the web server

# Improved comments explaining specific configurations within the server block
SERVER_CONFIG="
server {
...
# Set ownership for web application directory
